...
The only test I had trouble completing as the first child test. I was having issues because I used a semicolon to end my carson object property instaed of a comma. I deleted the semicoln and added a comma and it passed.It was just a syntax error.
How difficult was it to add and delete properties outside of the object itself?
Not difficult at all In a lot of ways its more fun and you feel more like a programmer when you delete, add, or alter properties outside the object as opposed to inside.
What did you learn about manipulating objects in this challenge?
I learned that when dealing with nested objects you need to be careful that you are using proper syntax and are modifying the right object.
*/
//
//
//
